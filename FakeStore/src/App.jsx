  ...
  return (
    <>
      <div className="flex flex-cols-2 p-6">
        <aside className="flex flex-col mr-12 gap-2 w-auto">
        ...
        <section className="grid grid-cols-1 w-48 md:w-full gap-1 md:grid-cols-2 lg:grid-cols-3">
          {productos.map(producto => (
            <Item key={producto.id} titulo={producto.title} precio={producto.price} imagenes={producto.images} descripcion={producto.description} categoria={producto.category.name} />
          ))}
        </section>
      </div>
    </>
